...
type AgentSessionWebhook = AgentSessionEventWebhookPayload;
...
function makeIssue(overrides: Record<string, unknown> = {}): any {
  return {
    id: "issue-1",
    identifier: "ENG-1",
    title: "Test issue",
...
function makeWebhook(overrides: Record<string, unknown> = {}): AgentSessionWebhook {
  return {
    ...
    ...overrides,
  } as unknown as AgentSessionWebhook;
}
